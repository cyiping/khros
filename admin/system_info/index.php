	...
	<div class="card card-outline card-dark rounded-0 shadow">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="name" class="control-label">系統名稱</label>
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label">系統短名稱</label>
				<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
			</div>
			<div class="form-group">
				<label for="content[about_us]" class="control-label">歡迎頁面內容</label>
			...
			<div class="form-group">
				<label for="content[about_us]" class="control-label">有關我們</label>
			...
			<div class="form-group">
				<label for="" class="control-label">系統Logo</label>
			...
			<div class="form-group">
				<label for="" class="control-label">首頁圖片</label>
				<div class="custom-file">
			...
			<fieldset>
				...
				<div class="form-group">
					<label for="contact" class="control-label">連絡電話號碼</label>
