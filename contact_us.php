    ...
    <div class="row my-5 ">
            ...
            <div class="card card-outline card-navy rounded-0 shadow">
                ...
                <div class="card-body rounded-0">
                    <dl>
                        ...
                        <dt class="text-muted"><i class="fa fa-phone"></i> 連絡電話 #</dt>
                        <dd class="pl-4"><?= $_settings->info('contact') ?></dd>
                        <dt class="text-muted"><i class="fa fa-map-marked-alt"></i> 公司位置</dt>
                        <dd class="pl-4"><?= $_settings->info('address') ?></dd>
                        <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1976.2263025311731!2d130.41467823352!3d33.589649703606845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x354191b881d355c1%3A0x97159ea43187cd26!2sFukuoka%20Center%20Building!5e0!3m2!1szh-CN!2stw!4v1716953420092!5m2!1szh-CN!2stw" width="360" height="270" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
                    </dl>
                </div>
            </div>
        </div>
        <div class="col-md-7">
            <div class="card rounded-0 card-outline card-navy shadow" >
                <div class="card-body rounded-0">
                    <h2 class="text-center">傳訊息給我們</h2>
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary rounded-pill col-5">傳送訊息</button>
                            </div>
                        </div>
                    </form>
                </div>
