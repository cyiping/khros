                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <thead>
                            <tr class="bg-gradient-primary text-light">
                                ...
                                <th><center>火車時刻</center></th>
                                <th><center>路線</center></th>
                                <th><center>Train</center></th>
                                <th><center>Slot/車費</center></th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-1" align="center">
                                        <a href="./?page=reserve&sid=<?= $row['id'] ?>" class="btn btn-flat btn-primary btn-sm" >訂位 <i class="fa fa-angle-right"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
