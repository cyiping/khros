...
<div class="content py-5">
    <div class="card rounded-0 card-outline card-primary shadow">
        <div class="card-header rounded-0">
            <h5 class="card-title">產生預定票券</h5>
            <div class="card-tools">
                <button class="btn btn-sm btn-flat btn-success" id="print"><i class="fa fa-print"></i> 列印</button>
            </div>
        </div>
        <div class="card-body rounded-0">
            <div id="outprint" class="list-group">
                ...
                <?php endforeach; ?>
                <br>
                <center><p>*** 注意 ! 要在時限內完成繳費之後，本預定才會生效喔 ! *** </p></center>
                <br>
                <center><p>*** 請持本單據到本公司完成繳費 *** </p></center>
            </div>
        </div>
    </div>
</div>
